...
--
-- Host: 127.0.0.1
-- Gegenereerd op: 03 mrt 2026 om 23:04
...
INSERT INTO `artikelen` (`artikel_id`, `naam`, `prijs`) VALUES
(1, 'Laptop', 899.99),
(2, 'Muis', 19.99),
(3, 'Toetsenbord', 49.99);
...
INSERT INTO `klanten` (`klant_id`, `naam`, `email`, `telefoon`) VALUES
(1, 'Jan Jansen', 'jan@email.nl', '0612345678'),
(2, 'Piet Pieters', 'piet@email.nl', '0623456789'),
(3, 'Klaas de Vries', 'klaas@email.nl', '0634567890');
